...
package object icache {
  ...
  /** The complete ICache port bundle, containing command and response flows.
    ...
    * @param pcWidth Width of the program counter.
    */
  case class ICachePort(iCfg: ICacheConfig, pcWidth: Int) extends Bundle with IMasterSlave with Formattable {
  ...
  /** Service trait for the ICache.
    ...
    */
  trait ICacheService extends Service with LockedImpl {
  ...
  /** Defines the structure of a single way's metadata (tag).
    ...
    */
  case class ICacheTagLine(iCfg: ICacheConfig, pcWidth: Int) extends Bundle with Formattable {
  ...
  /** Defines the structure of a full metadata line in the Tag/LRU RAM.
    ...
    */
  case class ICacheMetaLine(iCfg: ICacheConfig, pcWidth: Int) extends Bundle with Formattable {
